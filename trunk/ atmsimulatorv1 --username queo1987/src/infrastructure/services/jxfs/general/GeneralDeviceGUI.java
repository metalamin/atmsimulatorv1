...
public class GeneralDeviceGUI
    implements WindowConstants
{

    public GeneralDeviceGUI(String s, int i, int j, int k, int l, int i1, int j1)
    {
        ...
        p_flds_.setBorder(new EmptyBorder(k, l, i1, j1));
        ...
        frame_.setBounds(x,y,width,height);        
    }
    ...
    private static GeneralDeviceGUI g__;
